...
// Generate recipes route
app.post('/generate-recipes', (req, res) => {
    const {
        username,
        pantryItems = [],
        time = 60,
    ...
    // Calls Python script to execute your LLM code
    const pythonProcess = spawn('python3', [
        path.join(__dirname, '..', 'generate_recipes.py'),
    ...
    pythonProcess.on('close', (code) => {
      ...
      try {
          ...
          console.error('Tried to parse:', dataString);
          res.status(500).json({
              success: false,
